...
pub struct Voltage {
    ...
    #[serde(rename = "VoltageRange", default, skip_serializing_if = "Option::is_none")]
    pub voltage_range: Option<VoltageRange>,

    /// The fixed voltage (optional - either VoltageRange or FixedVoltage is used)
    #[serde(rename = "FixedVoltage", default, skip_serializing_if = "Option::is_none")]
...
pub struct ControlGear {
    ...
    #[serde(rename = "NominalVoltage", default, skip_serializing_if = "Option::is_none")]
    pub nominal_voltage: Option<Voltage>,

    /// The standby power consumption of the control gear.
    #[serde(rename = "StandbyPower", default, skip_serializing_if = "Option::is_none")]
    pub standby_power: Option<f64>,

    /// The power level at which constant light output starts.
    #[serde(rename = "ConstantLightOutputStartPower", default, skip_serializing_if = "Option::is_none")]
    pub constant_light_output_start_power: Option<f64>,

    /// The power level at which constant light output ends.
    #[serde(rename = "ConstantLightOutputEndPower", default, skip_serializing_if = "Option::is_none")]
    pub constant_light_output_end_power: Option<f64>,

    /// Power consumption controls associated with the control gear.
    #[serde(rename = "PowerConsumptionControls", default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "ColorControllable", default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "EnergyLabels", default, skip_serializing_if = "Option::is_none")]
...
pub struct Equipment {
    ...
    #[serde(rename = "LightSourceReference", default, skip_serializing_if = "Option::is_none")]
    pub light_source_reference: Option<LightSourceReference>,

    /// A reference to the control gear associated with the equipment.
    #[serde(rename = "ControlGearReference", default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "EmergencyBallastLumenFactor", default, skip_serializing_if = "Option::is_none")]
    pub emergency_ballast_lumen_factor: Option<f64>,

    /// The emergency rated luminous flux of the equipment.
    #[serde(rename = "EmergencyRatedLuminousFlux", default, skip_serializing_if = "Option::is_none")]
