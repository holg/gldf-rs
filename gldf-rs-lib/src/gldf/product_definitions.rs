...
pub struct LuminaireMaintenanceFactor {
    ...
    #[serde(rename = "@roomCondition", default, skip_serializing_if = "Option::is_none")]
...
pub struct LuminaireMaintenance {
    ...
    #[serde(rename = "Cie97LuminaireType", default, skip_serializing_if = "Option::is_none")]
    pub cie97_luminaire_type: Option<String>,

    /// CIE-specific luminaire maintenance factors.
    #[serde(rename = "CieLuminaireMaintenanceFactors", default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "IesLuminaireLightLossFactors", default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "JiegMaintenanceFactors", default, skip_serializing_if = "Option::is_none")]
...
pub struct Recessed {
    ...
    #[serde(rename = "RectangularCutout", default, skip_serializing_if = "Option::is_none")]
    pub rectangular_cutout: Option<RectangularCutout>,

    /// The circular cutout details for the recessed luminaire.
    #[serde(rename = "CircularCutout", default, skip_serializing_if = "Option::is_none")]
...
pub struct Wall {
    ...
    pub recessed: Option<Recessed>,
    /// The surface mounted type
    #[serde(rename = "SurfaceMounted", default, skip_serializing_if = "Option::is_none")]
    pub surface_mounted: Option<SurfaceMounted>,
    /// The depth in mm
    #[serde(rename = "Depth", default)]
    pub depth: i32,
...
pub struct Electrical {
    ...
    #[serde(rename = "ElectricalSafetyClass", skip_serializing_if = "Option::is_none")]
    pub electrical_safety_class: Option<String>,
    /// The ingress protection ip code
    #[serde(rename = "IngressProtectionIPCode", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "ConstantLightOutput", skip_serializing_if = "Option::is_none")]
...
pub struct Property {
    ...
    #[serde(rename = "FileReference", default, skip_serializing_if = "Option::is_none")]
