...
const StarSkyRendererFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_starskyrenderer_free(ptr >>> 0, 1));
...
export class StarSkyRenderer {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(StarSkyRenderer.prototype);
        obj.__wbg_ptr = ptr;
        StarSkyRendererFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        StarSkyRendererFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_starskyrenderer_free(ptr, 0);
    }
    /**
     * Get star count
     * @returns {number}
     */
    star_count() {
        const ret = wasm.starskyrenderer_star_count(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    ...
    get_stars_json() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.starskyrenderer_get_stars_json(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
    ...
    highlight_star(name) {
        ...
        wasm.starskyrenderer_highlight_star(this.__wbg_ptr, ptr0, len0);
    }
    /**
    ...
    load_from_storage(key) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.starskyrenderer_load_from_storage(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
    ...
    constructor(canvas_id) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.starskyrenderer_new(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        StarSkyRendererFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * Render the star sky
     */
    render() {
        wasm.starskyrenderer_render(this.__wbg_ptr);
    }
    /**
     * Resize canvas to fit parent
     */
    resize() {
        wasm.starskyrenderer_resize(this.__wbg_ptr);
    }
    /**
     * Get location name
     * @returns {string}
    ...
    location() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.starskyrenderer_location(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    load_json(json) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.starskyrenderer_load_json(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ret[0] >>> 0;
...
if (Symbol.dispose) StarSkyRenderer.prototype[Symbol.dispose] = StarSkyRenderer.prototype.free;
 ...
 * @returns {StarSkyRenderer}
 */
export function render_from_storage(canvas_id, storage_key) {
    const ptr0 = passStringToWasm0(canvas_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(storage_key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.render_from_storage(ptr0, len0, ptr1, len1);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return StarSkyRenderer.__wrap(ret[0]);
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_log_f047a250411a39af = function(arg0, arg1) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('gldf_starsky_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
